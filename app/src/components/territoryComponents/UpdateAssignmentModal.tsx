    ...
    <div id="assignment-modal">
      <div id="assignment-modal-body">
        ...
        <div className="input-row">
          ...
          <input type="ext" name="pubName" value={publisher} onChange={handlePublisherChange} />
        </div>
        <div className="input-row">
          <label htmlFor="checkOut">Check Out Date:</label>
          <input type="date" name="checkOut" value={checkOut} onChange={handleCheckOutChange} />
        </div>
        <div className="input-row">
          <label htmlFor="checkIn">Check In Date:</label>
          <input type="date" name="checkIn" value={checkIn} onChange={handleCheckInChange} />
        </div>
        <div>
